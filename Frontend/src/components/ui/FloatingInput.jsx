  ...
  return (
    <div className="relative">
      <input
        ...
        placeholder=" "
        {...props}
        className={`w-full rounded-xl border bg-white/70 px-4 pb-2.5 pt-5 text-sm text-ink outline-none transition focus:ring-2 ${
          error
      ...
      <label
        ...
        } ${error ? 'text-red-500' : focused ? 'text-brand' : 'text-ink/40'}`}
      >
        {label}
      </label>
    </div>
